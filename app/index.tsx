    ...
    if (showSplash) {
        return (
            <View style={styles.container}>
                <Image
                    // source={vpayLogo} alt='Vpay logo' // Use the imported local asset
                    style={styles.logo}
                />
            </View>
        );
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.paragraph}>
                Create virtual cards, manage transactions, and enhance your security with ease.
            </Text>
            <Link href="/unboarding" style={styles.buttonContainer}>
